...
def g_score(reference, generated):
    """
...
# print(f"G-score: {sent2, g_score(reference, sent2)}")
# print(f"G-score: {sent3, g_score(reference, sent3)}")
# print(f"G-score: {sent4, g_score(reference, sent4)}")
# print(f"G-score: {sent5 ,g_score(reference, sent5)}")
# print(f"G-score: {sent6, g_score(reference, sent6)}")
# print(f"G-score: {sent7, g_score(reference, sent7)}")
# print(f"G-score: {sent13, g_score(reference, sent13)}")
# print(f"G-score: {sent8, g_score(reference, sent8)}")
# print(f"G-score: {sent9, g_score(reference, sent9)}")
# print(f"G-score: {sent14, g_score(reference, sent14)}")
# print(f"G-score: {sent15, g_score(reference, sent15)}")
# print(f"G-score: {sent10, g_score(reference, sent10)}")
# print(f"G-score: {sent11, g_score(reference, sent11)}")
# print(f"G-score: {sent16, g_score(reference, sent16)}")
# print(f"G-score: {sent12, g_score(reference, sent12)}")
print(f"G-score: {sent17, g_score(reference, sent17)}")